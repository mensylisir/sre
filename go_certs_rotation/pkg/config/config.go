package config; import ("os"; "gopkg.in/yaml.v3");
...
func LoadConfig(path string) (*Config, error) { cfg := &Config{}; file, err := os.ReadFile(path); if err != nil { return nil, err }; return cfg, yaml.Unmarshal(file, cfg) }
